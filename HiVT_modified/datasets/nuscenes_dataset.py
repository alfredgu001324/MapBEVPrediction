...
def process_nuscenes(split, raw_path, centerline_used):
    ...
    # The method presented in the paper can only handle agents within the BEV perception range
    ...
    if len(keep_indices) == 0:
        keep_indices.append(500) # a random number
        flag = True
    ...
    bev_embed = torch.tensor(data['predicted_map']['bev_features'])
