        ...
        assigner=dict(
            type='HungarianLinesAssigner',
                cost=dict(
                    ...
                    reg_cost=dict(type='LinesL1Cost', weight=5, beta=0.01, permute=permute),
                    ),
                ),
        ),
    streaming_cfg=dict(
...
data_ann = '/MapBEVPrediction/processed/stream/'
data_ann_new = '/MapBEVPrediction/processed/stream_new/'
