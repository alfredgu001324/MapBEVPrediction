...
class MapTR(MVXTwoStageDetector):
    ...
    def forward_test(self, img_metas, img=None,points=None,  **kwargs):
        ...
        # print(img_metas[0][0]['sample_idx'])
    ...
    def pred2result(self, bboxes, scores, labels, pts, betas, bev, raw_scores, attrs=None):
        ...
        result_dict = dict(
            ...
            pts_3d=pts.to('cpu'),
            betas_3d=betas.to('cpu'),
            bev=bev.to('cpu'),
            raw_scores=raw_scores.to('cpu'))
    ...
    def simple_test_pts(self, x, lidar_feat, img_metas, prev_bev=None, rescale=False):
        ...
        bbox_results = [
            self.pred2result(bboxes, scores, labels, pts, betas, bev, raw_scores)
            for bboxes, scores, labels, pts, betas, bev, raw_scores in bbox_list
        ]
        # import pdb;pdb.set_trace()
        # breakpoint()
