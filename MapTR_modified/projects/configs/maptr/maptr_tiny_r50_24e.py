...
data_root = '/MapBEVPrediction/nuscenes/'
data_ann = '/MapBEVPrediction/processed/maptr/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_ann + 'nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_ann + 'nuscenes_infos_temporal_val.pkl',
             map_ann_file=data_ann + 'nuscenes_map_anns_val.json',
